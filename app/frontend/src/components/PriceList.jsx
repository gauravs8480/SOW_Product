...
const PriceList = () => {
  ...
  const handleDeleteProduct = async () => {
    try {
      await axios.delete(
        `http://127.0.0.1:3001/api/products/${selectedProduct.id}`
      );
  ...
  <div className="relative w-60">
    <input
      ...
      className="border rounded px-3 py-1 text-sm w-full pl-8"
      value={articleSearch}
            ...
            <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
              <div className="bg-white rounded-lg shadow-xl p-6 max-w-lg w-full">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    <strong>Article No:</strong> {selectedProduct.article_no}
                  </li>
                  <li>
                    <strong>Product Name:</strong> {selectedProduct.name}
                  </li>
                  <li>
                    <strong>In Price:</strong> {selectedProduct.in_price}
                  </li>
                  <li>
          ...
          {(showAddProduct || editMode) && (
            <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
              <div className="bg-white rounded-lg shadow-xl p-6 max-w-lg w-full">
                ...
                <form
                  onSubmit={editMode ? handleEditProduct : handleAddProduct}
                >
                  <div className="space-y-3">
                    <input
                      type="text"
                      placeholder="Article No"
                      defaultValue={selectedProduct?.article_no || ""}
                      required
                    ...
                    <input
                      ...
                      defaultValue={selectedProduct?.in_price || ""}
                      required
                      className="border rounded px-3 py-1 w-full"
                    />
                    <input
